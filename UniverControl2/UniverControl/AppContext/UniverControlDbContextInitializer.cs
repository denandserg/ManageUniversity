...
{
    //DropCreateDatabaseAlways<UniverControlDbContext>
    //DropCreateDatabaseIfModelChanges<UniverControlDbContext>
    //CreateDatabaseIfNotExists<UniverControlDbContext>

    public class UniverControlDbContextInitializer : CreateDatabaseIfNotExists<UniverControlDbContext>
    {
        protected override void Seed(UniverControlDbContext context)
        {
            base.Seed(context);
